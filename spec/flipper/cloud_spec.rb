...
RSpec.describe Flipper::Cloud do
  ...
  it 'can import' do
    ...
    get_all = {
      "logging" => {actors: Set.new, boolean: nil, comparisons: Set.new, groups: Set.new, percentage_of_actors: nil, percentage_of_time: "5"},
      "search" => {actors: Set.new, boolean: "true", comparisons: Set.new, groups: Set.new, percentage_of_actors: nil, percentage_of_time: nil},
      "stats" => {actors: Set["jnunemaker"], boolean: nil, comparisons: Set.new, groups: Set.new, percentage_of_actors: nil, percentage_of_time: nil},
      "test" => {actors: Set.new, boolean: "true", comparisons: Set.new, groups: Set.new, percentage_of_actors: nil, percentage_of_time: nil},
    }
